<%-- 
    Document   : empleado_registrar
    Created on : 29/10/2021, 03:24:16 PM
    Author     : rozo
--%>
            ...
            <div id="content">
                ...
                <div style="justify-content:center;" class="form-row">
                    <div class="form-group col-md-10">
                        <form name="form1" action="../RegisterEmploye.do" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="pais" id="pais" required>
                                        ...
                                        <option value="<%= pais%>" data-num="<%= num%>" name="<%= pais%>"> <%= pais%> </option>   
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control" name="tipo" id="tipo" required>
                                        <option disabled selected norequired>Seleccione</option>
                                        <option value="planta" name="planta">Planta</option>
                                        <option value="independiente" name="independiente">Independiente</option>
                                    </select>
                                </div>
        ...
        <script>
            ...
            select.addEventListener('change',
                    function () {
                        ...
                        var opcion = selectedOption.getAttribute('data-num');
