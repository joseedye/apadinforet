<%-- 
    Document   : perfil
    Created on : 20/10/2021, 06:45:13 PM
    Author     : rozo
--%>
                            ...
                            <form name="form1" action="../UpdateProfile.do" method="post">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="nombres" class="form-control" id="" readonly=»readonly» placeholder="Nombre" value="<%=user.get("nombres")%>" maxlength="100" required>

                                        <label for="">Documento</label>
                                        <input type="number" name="numDocumento" pattern="[0-9]+" readonly=»readonly» class="form-control" id="" placeholder="Documento" value="<%=user.get("numDocumento")%>" onKeyUp="if (this.value.length > 10) {
                                        ...
                                        <input class="form-control" type="date" readonly=»readonly» name="FechaNac" value="<%=user.get("fecNacimiento") + ""%>" required>

                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="">Primer Apellido</label>
                                        <input type="text" name="ap1" class="form-control" readonly=»readonly» id="" placeholder="Primer Apellido" value="<%=user.get("apellido1") + ""%>" maxlength="15" required>

                                        <label for="">Género</label>
                                        <input type="text" name="genero" class="form-control" readonly=»readonly» id="" placeholder="genero" value="<%=user.get("genero")%>" maxlength="15" required>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" name="ap2" class="form-control" readonly=»readonly» id="" placeholder="Segundo Apellido" value="<%=user.get("apellido2")%>" maxlength="15" required>
