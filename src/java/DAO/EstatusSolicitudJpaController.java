...
public class EstatusSolicitudJpaController implements Serializable {
    ...
    public void create(EstatusSolicitud estatusSolicitud) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findEstatusSolicitud(estatusSolicitud.getIdEstatus()) != null) {
                throw new PreexistingEntityException("EstatusSolicitud " + estatusSolicitud + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void edit(EstatusSolicitud estatusSolicitud) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            em = getEntityManager();
            em.getTransaction().begin();
            EstatusSolicitud persistentEstatusSolicitud = em.find(EstatusSolicitud.class, estatusSolicitud.getIdEstatus());
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = estatusSolicitud.getIdEstatus();
